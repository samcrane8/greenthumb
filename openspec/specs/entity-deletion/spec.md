# entity-deletion Specification

## Purpose

Let users delete drivers, scenarios, and whole models after creation with
reference safety — stripping driver ids from scenario overrides, blocking removal
of a referenced driver, never removing the last scenario — as validate-on-write
