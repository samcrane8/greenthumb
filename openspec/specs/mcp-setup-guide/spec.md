# mcp-setup-guide Specification

## Purpose

Give users an in-app guide for connecting an MCP client to their running
greenthumb instance, with accurate prerequisites, copy-paste configuration for
Claude Desktop and Codex, and troubleshooting for the common failure modes.
